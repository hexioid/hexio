  			  ...
  			  <!-- <div class="header-infos-sub"> -->
  			    <?php if(cryptokn_redux('mt_divider_header_info_1_status') == true){ ?>
  			      ...
  			      <div class="text-center header-info-group">
  			        <div class="header-info-icon pull-left text-center <?php echo esc_attr(cryptokn_redux('mt_divider_header_info_1_media_type')); ?>">
  			          ...
  			          <?php }elseif(cryptokn_redux('mt_divider_header_info_1_media_type') == 'text_title'){ ?>
  			          	<p class="header_text_title"><?php echo esc_html(cryptokn_redux('mt_divider_header_info_1_text_1')); ?>
  			          <?php } ?>
  			        </div>
  			        <div class="header-info-labels pull-left">
  			          <p><?php echo esc_html(cryptokn_redux('mt_divider_header_info_1_heading1')); ?></p>
  			        </div>
  			      </div>
  			      <!-- // HEADER INFO 1 -->
  			    <?php } ?>
  			    ...
  			    <?php if(cryptokn_redux('mt_divider_header_info_2_status') == true){ ?>
  			      <!-- HEADER INFO 2 -->
  			      <div class="text-center header-info-group">
  			        <div class="header-info-icon pull-left text-center <?php echo esc_attr(cryptokn_redux('mt_divider_header_info_2_media_type')); ?>">
  			          ...
  			          <?php }elseif(cryptokn_redux('mt_divider_header_info_2_media_type') == 'text_title'){ ?>
  			          	<p class="header_text_title"><?php echo esc_html(cryptokn_redux('mt_divider_header_info_2_text_2')); ?>
  			          <?php } ?>
  			        </div>
  			        <div class="header-info-labels pull-left">
  			          <p><?php echo esc_html(cryptokn_redux('mt_divider_header_info_2_heading1')); ?></p>
  			        </div>
  			      </div>
  			      <!-- // HEADER INFO 2 -->
  			    <?php } ?>
  			    ...
  			    <?php if(cryptokn_redux('mt_divider_header_info_3_status') == true){ ?>
  			      <!-- HEADER INFO 3 -->
  			      <div class="text-center header-info-group">
  			        <div class="header-info-icon pull-left text-center <?php echo esc_attr(cryptokn_redux('mt_divider_header_info_3_media_type')); ?>">
  			          ...
  			          <?php }elseif(cryptokn_redux('mt_divider_header_info_3_media_type') == 'text_title'){ ?>
  			          	<p class="header_text_title"><?php echo esc_html(cryptokn_redux('mt_divider_header_info_3_text_3')); ?>
  			          <?php } ?>
  			        </div>
  			        <div class="header-info-labels pull-left">
  			          <p class="call_us_class"><?php echo esc_html(cryptokn_redux('mt_divider_header_info_3_heading1')); ?></p>
  			        </div>
  			      </div>
  			      <!-- // HEADER INFO 3 -->
  			    <?php } ?>
