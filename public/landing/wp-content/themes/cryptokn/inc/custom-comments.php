...
function cryptokn_custom_comments($comment, $args, $depth) {
...
?>
    ...
    <div id="div-comment-<?php comment_ID() ?>" class="comment-body fullwidth single_comment parent">
        ...
        <?php if ( $comment->comment_approved == '0' ) : ?>
            <em class="comment-awaiting-moderation"><?php esc_html_e( 'Your comment is awaiting moderation.','cryptokn' ); ?></em>
        <?php endif; ?>
        ...
        <div class="comment-meta commentmetadata col-md-11 comment_body relative">
            ...
            <span class="reply_button1 col-md-3 text-left">
                <?php edit_comment_link( esc_html__( 'Edit', 'cryptokn' ), '  ', '' ); ?>
