<?php
	...
	*/
    ...
    function cryptokn_loader_animation(){

        global  $cryptokn_redux;
        
        $html = '';

        if (isset($cryptokn_redux['mt_preloader_animation'])) {
            if ($cryptokn_redux['mt_preloader_animation'] == 'v1_ball_triangle') {
                $html .= '<div class="cryptokn_preloader v1_ball_triangle">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($cryptokn_redux['mt_preloader_animation'] == 'v2_ball_pulse'){
                $html .= '<div class="cryptokn_preloader v2_ball_pulse">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($cryptokn_redux['mt_preloader_animation'] == 'v3_ball_grid_pulse'){
                $html .= '<div class="cryptokn_preloader v3_ball_grid_pulse">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($cryptokn_redux['mt_preloader_animation'] == 'v4_ball_clip_rotate'){
                $html .= '<div class="cryptokn_preloader v4_ball_clip_rotate">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($cryptokn_redux['mt_preloader_animation'] == 'v5_ball_clip_rotate_pulse'){
                $html .= '<div class="cryptokn_preloader v5_ball_clip_rotate_pulse">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($cryptokn_redux['mt_preloader_animation'] == 'v6_square_spin'){
                $html .= '<div class="cryptokn_preloader v6_square_spin">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($cryptokn_redux['mt_preloader_animation'] == 'v7_ball_clip_rotate_multiple'){
                $html .= '<div class="cryptokn_preloader v7_ball_clip_rotate_multiple">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($cryptokn_redux['mt_preloader_animation'] == 'v8_ball_pulse_rise'){
                $html .= '<div class="cryptokn_preloader v8_ball_pulse_rise">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($cryptokn_redux['mt_preloader_animation'] == 'v9_ball_rotate'){
                $html .= '<div class="cryptokn_preloader v9_ball_rotate">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($cryptokn_redux['mt_preloader_animation'] == 'v10_cube_transition'){
                $html .= '<div class="cryptokn_preloader v10_cube_transition">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($cryptokn_redux['mt_preloader_animation'] == 'v11_ball_zig_zag'){
                $html .= '<div class="cryptokn_preloader v11_ball_zig_zag">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($cryptokn_redux['mt_preloader_animation'] == 'v12_ball_zig_zag_deflect'){
                $html .= '<div class="cryptokn_preloader v12_ball_zig_zag_deflect">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($cryptokn_redux['mt_preloader_animation'] == 'v13_ball_scale'){
                $html .= '<div class="cryptokn_preloader v13_ball_scale">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($cryptokn_redux['mt_preloader_animation'] == 'v14_line_scale'){
                $html .= '<div class="cryptokn_preloader v14_line_scale">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($cryptokn_redux['mt_preloader_animation'] == 'v15_line_scale_party'){
                $html .= '<div class="cryptokn_preloader v15_line_scale_party">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($cryptokn_redux['mt_preloader_animation'] == 'v16_ball_scale_multiple'){
                $html .= '<div class="cryptokn_preloader v16_ball_scale_multiple">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($cryptokn_redux['mt_preloader_animation'] == 'v17_ball_pulse_sync'){
                $html .= '<div class="cryptokn_preloader v17_ball_pulse_sync">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($cryptokn_redux['mt_preloader_animation'] == 'v18_ball_beat'){
                $html .= '<div class="cryptokn_preloader v18_ball_beat">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($cryptokn_redux['mt_preloader_animation'] == 'v19_line_scale_pulse_out'){
                $html .= '<div class="cryptokn_preloader v19_line_scale_pulse_out">
                            <div class="loaders">
                                <div class="loader">
            ...
            }elseif($cryptokn_redux['mt_preloader_animation'] == 'v20_line_scale_pulse_out_rapid'){
                $html .= '<div class="cryptokn_preloader v20_line_scale_pulse_out_rapid">
                            <div class="loaders">
                                <div class="loader">
	...
	/**
Function name:              cryptokn_footer_row1()
Function description:       Footer row 1
*/
function cryptokn_footer_row1(){

    global  $cryptokn_redux;


    // if (is_active_sidebar( 'footer_row_1_1') || is_active_sidebar( 'footer_row_1_2') || is_active_sidebar( 'footer_row_1_3') || is_active_sidebar( 'footer_row_1_4') || is_active_sidebar( 'footer_row_1_5')) {
        echo '<div class="row">';
            echo '<div class="col-md-12 footer-row-1">';
                echo '<div class="row">';

                $footer_row_1_layout = $cryptokn_redux['mt_footer_row_1_layout'];
                $nr = array("1", "2", "3", "4", "6");
...
/**
Function name:              cryptokn_footer_row2()
Function description:       Footer row 2
*/
function cryptokn_footer_row2(){

    global  $cryptokn_redux;

    if (is_active_sidebar( 'footer_row_2_1') || is_active_sidebar( 'footer_row_2_2') || is_active_sidebar( 'footer_row_2_3') || is_active_sidebar( 'footer_row_2_4') || is_active_sidebar( 'footer_row_2_5')) {
        echo '<div class="row">';
            echo '<div class="col-md-12 footer-row-2">';
                echo '<div class="row">';

                $footer_row_2_layout = $cryptokn_redux['mt_footer_row_2_layout'];
                $nr = array("1", "2", "3", "4", "6");
...
/**
Function name:              cryptokn_footer_row3()
Function description:       Footer row 3
*/
function cryptokn_footer_row3(){

    global  $cryptokn_redux;

    if (is_active_sidebar( 'footer_row_3_1') || is_active_sidebar( 'footer_row_3_2') || is_active_sidebar( 'footer_row_3_3') || is_active_sidebar( 'footer_row_3_4') || is_active_sidebar( 'footer_row_3_5')) {
        echo '<div class="row">';
            echo '<div class="col-md-12 footer-row-3">';
                echo '<div class="row">';

                $footer_row_3_layout = $cryptokn_redux['mt_footer_row_3_layout'];
                $nr = array("1", "2", "3", "4", "6");
