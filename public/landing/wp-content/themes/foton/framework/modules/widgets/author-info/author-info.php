...
class FotonMikadoClassAuthorInfoWidget extends FotonMikadoClassWidget {
	...
	public function widget( $args, $instance ) {
		...
		<div class="widget mkdf-author-info-widget <?php echo esc_html( $extra_class ); ?>" <?php echo foton_mikado_get_inline_style( $widget_styles ); ?>>
