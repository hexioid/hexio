					...
					<div class="row">
						<div class="col-lg-12">
							<div class="mkdf-media-uploader">
								...
								<a class="mkdf-media-upload-btn btn btn-sm btn-primary" href="javascript:void(0)" data-frame-title="<?php esc_attr_e( 'Select File', 'foton' ); ?>" data-frame-button-text="<?php esc_html_e( 'Select File', 'foton' ); ?>"><?php esc_html_e( 'Upload', 'foton' ); ?></a>
