...
class Precise_Widget_Twitter_Feed extends WP_Widget {

    public function __construct(){
        parent::__construct(
            'twitter_feed',
            esc_html__('[Precise] - Twitter Feed', 'precise'),
            array(
                'description' => esc_html__('Display Twitter Feed', 'precise')
            )
        );
    }
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'screen_name' ) ); ?>"><?php esc_attr_e( 'Screen Name:', 'precise' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>"><?php esc_attr_e( 'Number Feed:', 'precise' ); ?></label>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'enable_slider' ) ); ?>"><?php esc_attr_e( 'Enable Slider:', 'precise' ); ?></label>
        </p>
        <?php
    }
