...
if(!class_exists('Precise_Helper')){

    class Precise_Helper{
        ...
        public static function render_access_component( $type, $component = array(), $parent_name = '', $css_class = ''){
            ...
            switch($type){
                ...
                case 'primary_menu':
                    ...
                    $icon_html = '<i class="precise-icon-menu"></i>';
                    $target_html = '<a class="component-target" href="javascript:;">'.$icon_html.'</a>';
                    break;
                ...
                case 'search_1':
                    ...
                    $icon_html = '<i class="precise-icon-zoom"></i>';
                    $target_html = '<a class="component-target" href="javascript:;">'.$icon_html.'</a>';
                    break;
                ...
                case 'cart':
                    ...
                    $icon_html = '<i class="precise-icon-cart-modern"></i><span class="component-target-badget la-cart-count">-</span>';
                    $target_html = '<a class="component-target" href="'.$target_url.'">'.$icon_html.'</a>';
                    break;
                ...
                case 'wishlist':
                    ...
                    $icon_html = '<i class="precise-icon-favourite2"></i><span class="component-target-badget la-wishlist-count">-</span>';
                    $target_html = '<a class="component-target" href="'.$target_url.'">'.$icon_html.'</a>';
                    break;
                ...
                case 'compare':
                    ...
                    $target_url = isset($component['link']) ? $component['link'] : '#';
                    $icon_html = '<i class="precise-icon-loop-alt3"></i><span class="component-target-badget la-wishlist-count">-</span>';
                    $target_html = '<a class="component-target" href="'.$target_url.'">'.$icon_html.'</a>';
                    break;
            }
