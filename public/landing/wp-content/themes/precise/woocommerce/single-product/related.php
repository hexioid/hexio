...
if ( $related_products ) : ?>
	...
	$product_cols = shortcode_atts(
		...
		Precise()->settings->get('related_products_columns')
	);
	...
	$title = Precise()->settings->get('related_product_title') ? Precise()->settings->get('related_product_title') : _x( 'Related Products', 'front-view', 'precise' );
	$sub_title = Precise()->settings->get('related_product_subtitle') ? Precise()->settings->get('related_product_subtitle') : '';
	?>
