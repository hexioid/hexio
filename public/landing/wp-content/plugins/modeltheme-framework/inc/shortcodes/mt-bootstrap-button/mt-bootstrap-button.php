...
function modeltheme_btn_shortcode($params, $content) {
    ...
    $content .= '<style type="text/css" scoped>
                .modeltheme_button .'.$id_selector.' {
                  ...
                  background: -moz-linear-gradient(top, '.esc_attr($gradient_color_1).' 0%, '.esc_attr($gradient_color_1).' 0%, '.esc_attr($gradient_color_1).' 0%, '.esc_attr($gradient_color_1).' 0%, '.esc_attr($gradient_color_2).' 100%, '.esc_attr($gradient_color_2).' 100%, '.esc_attr($gradient_color_2).' 100%) !important;
                  background: -webkit-linear-gradient(top, '.esc_attr($gradient_color_1).' 0%,'.esc_attr($gradient_color_1).' 0%,'.esc_attr($gradient_color_1).' 0%,'.esc_attr($gradient_color_1).' 0%,'.esc_attr($gradient_color_2).' 100%,'.esc_attr($gradient_color_2).' 100%,'.esc_attr($gradient_color_2).' 100%) !important;
                  background: linear-gradient(to bottom, '.esc_attr($gradient_color_1).' 0%,'.esc_attr($gradient_color_1).' 0%,'.esc_attr($gradient_color_1).' 0%,'.esc_attr($gradient_color_1).' 0%,'.esc_attr($gradient_color_2).' 100%,'.esc_attr($gradient_color_2).' 100%,'.esc_attr($gradient_color_2).' 100%) !important;
                  filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='.esc_attr($gradient_color_1).', endColorstr='.esc_attr($gradient_color_2).',GradientType=0 ) !important;
                  transform: scale(1.0);
