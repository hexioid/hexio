...
include_once( 'mt-members/mt-members-slider-v2.php' ); # Members 02
include_once( 'mt-services/mt_custom_service.php' ); # Services 03
include_once( 'mt-contact/mt-contact01.php' );
include_once( 'mt-blog-posts/mt-blogpost01.php' ); # Blog Post 1
include_once( 'mt-blog-posts/mt-blogpost02.php' ); # Blog Post 2
...
include_once( 'mt-timeline/mt-timeline-vertical.php' ); # vertical timeline
include_once( 'mt-tokens-panel/mt-tokens-panel.php' ); # tokens panel
