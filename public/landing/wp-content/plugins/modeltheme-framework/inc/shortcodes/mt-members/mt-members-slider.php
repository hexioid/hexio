                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="members_img_holder">
                                    ...
                                    <div class="slide_info">
                                        <h3 style="color:'.$heading_color.';" class="member01_name">'.$member_title.'</h3>
                                        <p style="color:'.$text_color.';" class="member01_position">'.$metabox_member_position.'</p>
                                    </div>
                                    <a href="'.$button_link.'" class="member_button" style="color:'.$button_color.';background-color:'.$button_background.';">'.$button_text.'</a>
...
if ( is_plugin_active( 'js_composer/js_composer.php' ) ) {
    ...
    vc_map( array(
        "name" => esc_attr__("MT - Members Slider Version 1", 'modeltheme'),
        ...
        "params" => array(
            ...
            array(
                ...
                "value" => "",
                "description" => esc_attr__( "Enter the button text.", 'modeltheme' )
            ),
            array(
                "group" => "Button Options",
                "type" => "textfield",
                ...
                "value" => "",
                "description" => esc_attr__( "Enter the button link.", 'modeltheme' )
            ),
            array(
                  "group" => "Button Options",
                  "type" => "colorpicker",
                  "class" => "",
                  "heading" => esc_attr__( "Button background", 'modeltheme' ),
                  "param_name" => "button_background",
                  "value" => "", //Default color
                  "description" => esc_attr__( "Choose the background for button.", 'modeltheme' )
            ),
            array(
                  "group" => "Button Options",
                  "type" => "colorpicker",
                  ...
                  "value" => "", //Default color
                  "description" => esc_attr__( "Choose the color for button text.", 'modeltheme' )
            ),
        )
    ));
}
