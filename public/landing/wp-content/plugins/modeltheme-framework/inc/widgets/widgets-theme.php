...
/* ========= social_icons ===================================== */
class bitwallet_address_social_icons extends WP_Widget {



    function __construct() {
        parent::__construct('bitwallet_address_social_icons', esc_attr__('MT - Contact + Social links', 'bitwallet'),array( 'description' => esc_attr__( 'MT - Contact information + Social icons', 'bitwallet' ), ) );
    }
        ...
        <div class="sidebar-social-networks address-social-links">
            ...
            <?php if('on' == $instance['widget_contact_details']) { ?>
                <div class="contact-details">
                    <p><i class="fa fa-phone" aria-hidden="true"></i><?php echo esc_attr( bitwallet_redux('mt_contact_phone')); ?></p>
                    <p><i class="fa fa-envelope" aria-hidden="true"></i><?php echo esc_attr( bitwallet_redux('mt_contact_email')); ?></p>
                    <p><i class="fa fa-map-marker" aria-hidden="true"></i><?php echo esc_attr( bitwallet_redux('mt_contact_address')); ?></p>
                </div>
            <?php } ?>
            ...
            <?php if('on' == $instance['widget_social_icons']) { ?>
                ...
                <?php if ( bitwallet_redux('mt_social_fb') && bitwallet_redux('mt_social_fb') != '' ) { ?>
                    <li><a href="<?php echo esc_attr( bitwallet_redux('mt_social_fb') ) ?>"><i class="fa fa-facebook"></i></a></li>
                <?php } ?>
                <?php if ( bitwallet_redux('mt_social_tw') && bitwallet_redux('mt_social_tw') != '' ) { ?>
                    <li><a href="<?php echo esc_url( bitwallet_redux('mt_social_tw') ) ?>"><i class="fa fa-twitter"></i></a></li>
                <?php } ?>
                <?php if ( bitwallet_redux('mt_social_gplus') && bitwallet_redux('mt_social_gplus') != '' ) { ?>
                    <li><a href="<?php echo esc_url( bitwallet_redux('mt_social_gplus') ) ?>"><i class="fa fa-google-plus"></i></a></li>
                <?php } ?>
                <?php if ( bitwallet_redux('mt_social_youtube') && bitwallet_redux('mt_social_youtube') != '' ) { ?>
                    <li><a href="<?php echo esc_url( bitwallet_redux('mt_social_youtube') ) ?>"><i class="fa fa-youtube"></i></a></li>
                <?php } ?>
                <?php if ( bitwallet_redux('mt_social_pinterest') && bitwallet_redux('mt_social_pinterest') != '' ) { ?>
                    <li><a href="<?php echo esc_url( bitwallet_redux('mt_social_pinterest') ) ?>"><i class="fa fa-pinterest"></i></a></li>
                <?php } ?>
                <?php if ( bitwallet_redux('mt_social_linkedin') && bitwallet_redux('mt_social_linkedin') != '' ) { ?>
                    <li><a href="<?php echo esc_url( bitwallet_redux('mt_social_linkedin') ) ?>"><i class="fa fa-linkedin"></i></a></li>
                <?php } ?>
                <?php if ( bitwallet_redux('mt_social_skype') && bitwallet_redux('mt_social_skype') != '' ) { ?>
                    <li><a href="<?php echo esc_url( bitwallet_redux('mt_social_skype') ) ?>"><i class="fa fa-skype"></i></a></li>
                <?php } ?>
                <?php if ( bitwallet_redux('mt_social_instagram') && bitwallet_redux('mt_social_instagram') != '' ) { ?>
                    <li><a href="<?php echo esc_url( bitwallet_redux('mt_social_instagram') ) ?>"><i class="fa fa-instagram"></i></a></li>
                <?php } ?>
                <?php if ( bitwallet_redux('mt_social_dribbble') && bitwallet_redux('mt_social_dribbble') != '' ) { ?>
                    <li><a href="<?php echo esc_url( bitwallet_redux('mt_social_dribbble') ) ?>"><i class="fa fa-dribbble"></i></a></li>
                <?php } ?>
                <?php if ( bitwallet_redux('mt_social_deviantart') && bitwallet_redux('mt_social_deviantart') != '' ) { ?>
                    <li><a href="<?php echo esc_url( bitwallet_redux('mt_social_deviantart') ) ?>"><i class="fa fa-deviantart"></i></a></li>
                <?php } ?>
                <?php if ( bitwallet_redux('mt_social_digg') && bitwallet_redux('mt_social_digg') != '' ) { ?>
                    <li><a href="<?php echo esc_url( bitwallet_redux('mt_social_digg') ) ?>"><i class="fa fa-digg"></i></a></li>
                <?php } ?>
                <?php if ( bitwallet_redux('mt_social_flickr') && bitwallet_redux('mt_social_flickr') != '' ) { ?>
                    <li><a href="<?php echo esc_url( bitwallet_redux('mt_social_flickr') ) ?>"><i class="fa fa-flickr"></i></a></li>
                <?php } ?>
                <?php if ( bitwallet_redux('mt_social_stumbleupon') && bitwallet_redux('mt_social_stumbleupon') != '' ) { ?>
                    <li><a href="<?php echo esc_url( bitwallet_redux('mt_social_stumbleupon') ) ?>"><i class="fa fa-stumbleupon"></i></a></li>
                <?php } ?>
                <?php if ( bitwallet_redux('mt_social_tumblr') && bitwallet_redux('mt_social_tumblr') != '' ) { ?>
                    <li><a href="<?php echo esc_url( bitwallet_redux('mt_social_tumblr') ) ?>"><i class="fa fa-tumblr"></i></a></li>
                <?php } ?>
                <?php if ( bitwallet_redux('mt_social_vimeo') && bitwallet_redux('mt_social_vimeo') != '' ) { ?>
                    <li><a href="<?php echo esc_url( bitwallet_redux('mt_social_vimeo') ) ?>"><i class="fa fa-vimeo-square"></i></a></li>
                <?php } ?>
                </ul>
            <?php } ?>
    ...
    public function form( $instance ) {
        ...
        if ( isset( $instance[ 'widget_title' ] ) ) {
            ...
            $widget_title = esc_attr__( 'Social icons', 'bitwallet' );
        }
        ?>

        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'widget_title' )); ?>"><?php esc_attr_e( 'Widget Title:','bitwallet' ); ?></label> 
        ...
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_name('widget_contact_details')); ?>"><?php esc_attr_e( 'Show contact informations box','bitwallet' ); ?></label>
        </p>
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_name('widget_social_icons')); ?>"><?php esc_attr_e( 'Show social icons','bitwallet' ); ?></label>
        </p>
...
*/
        ?>
        <p><?php esc_attr_e( '* Social Network account must be set from MT - Theme Panel.','bitwallet' ); ?></p>
        <?php 
    }
...
/* ========= Flickr_Feed_Widget ===================================== */
class bitwallet_flickr extends WP_Widget { 
    
    function __construct() {
        $widget_ops = array('description' => esc_attr__('Display latest Flickr Feed','bitwallet') );
        $control_ops = array( 'width' => 60, 'height' => 60, 'id_base' => 'flickr' );
        parent::__construct( 'bitwallet_flickr', esc_attr__('MT - Flickr Feed','bitwallet'), $widget_ops, $control_ops );
    }
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php esc_attr_e('Title of the Widget', 'bitwallet'); ?></label>
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'title' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'title' )); ?>" value="<?php echo esc_attr($instance['title']); ?>" />
        </p>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'username' )); ?>"><?php esc_attr_e('Your Flickr ID:', 'bitwallet'); ?></label>
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'username' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'username' )); ?>" value="<?php echo esc_attr($instance['username']); ?>" /><br /><a href="<?php echo esc_url_raw( 'http://idgettr.com/' ); ?>" target="_blank"><?php esc_attr_e('Flickr idGettr','bitwallet'); ?></a>
        </p>

        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'pics' )); ?>"><?php esc_attr_e('Number of Photos to show:', 'bitwallet'); ?></label>
...
/* ========= bitwallet_recent_entries_with_thumbnail ===================================== */
class bitwallet_recent_entries_with_thumbnail extends WP_Widget {

    /**
     * Register widget with WordPress.
     */
    function __construct() {
        parent::__construct('bitwallet_recent_entries_with_thumbnail', esc_attr__('MT - Recent Posts with thumbnails', 'bitwallet'),array( 'description' => esc_attr__( 'MT - Recent Posts with thumbnails', 'bitwallet' ), ) );
    }
    ...
    public function widget( $args, $instance ) {
        ...
        foreach ($recentposts as $post) {
            $thumbnail_src = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ),'cryptokn_post_widget_pic85x85' );
                ...
                $myContent .= '<div class="vc_col-md-2 post-thumbnail relative">';
                    $myContent .= '<a href="'. get_permalink($post->ID) .'">';
                        ...
                        $myContent .= '<div class="thumbnail-overlay absolute">';
                            $myContent .= '<i class="fa fa-btc absolute"></i>';
                        $myContent .= '</div>';
                    $myContent .= '</a>';
                $myContent .= '</div>';
    ...
    public function form( $instance ) {
        ...
        if ( isset( $instance[ 'recent_posts_title' ] ) ) {
            ...
            $recent_posts_title = esc_attr__( 'Recent posts', 'bitwallet' );
        }
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'recent_posts_title' )); ?>"><?php esc_attr_e( 'Widget Title:','bitwallet' ); ?></label> 
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'recent_posts_number' )); ?>"><?php esc_attr_e( 'Number of posts:','bitwallet' ); ?></label> 
...
/* ========= Tabs Widget ===================================== */
class bitwallet_popular_recent_tabs extends WP_Widget {

    /**
     * Register widget with WordPress.
     */
    function __construct() {
        parent::__construct('bitwallet_popular_recent_tabs', esc_attr__('MT - TABS: Random, Recent posts', 'bitwallet'),array( 'description' => esc_attr__( 'MT - TABS: Random, Recent posts', 'bitwallet' ), ) );
    }
        ...
        $myContent .= '<div class="widget_body">';
            ...
            $myContent .= '<div class="tab-content">';
                ...
                foreach ($popularposts as $post) {
                    $thumbnail_src = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ),'bitwallet_post_pic700x450' );
                    ...
                    $myContent .= '<div class="recent-post">';
                        ...
                        $myContent .= '<div class="post-description">'.bitwallet_excerpt_limit($excerpt,10).'</div>';
                    $myContent .= '</div>';
                }
                $myContent .= '</div>';
    ...
    public function form( $instance ) {
        ...
        if ( isset( $instance[ 'recent_posts_title' ] ) ) {
            ...
            $recent_posts_title = esc_attr__( 'Tab Widget', 'bitwallet' );
        }
        ...
        if ( isset( $instance[ 'title_first_tab' ] ) ) {
            ...
            $title_first_tab = esc_attr__( 'Random posts', 'bitwallet' );
        }
        # Number of posts
        ...
        if ( isset( $instance[ 'title_second_tab' ] ) ) {
            ...
            $title_second_tab = esc_attr__( 'Recent posts', 'bitwallet' );
        }
        # Number of posts
        if ( isset( $instance[ 'recent_posts_number' ] ) ) {
            $recent_posts_number = $instance[ 'recent_posts_number' ];
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'title_first_tab' )); ?>"><?php esc_attr_e( 'Number of recent posts:','bitwallet' ); ?></label> 
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'recent_posts_number' )); ?>"><?php esc_attr_e( 'Number of recent posts:','bitwallet' ); ?></label> 
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'recent_posts_number' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'recent_posts_number' )); ?>" type="text" value="<?php echo esc_attr( $recent_posts_number ); ?>">
        </p>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'title_second_tab' )); ?>"><?php esc_attr_e( 'Number of popular posts:','bitwallet' ); ?></label> 
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'popular_posts_number' )); ?>"><?php esc_attr_e( 'Number of popular posts:','bitwallet' ); ?></label> 
...
/* ========= bitwallet_post_thumbnails_slider ===================================== */
class bitwallet_post_thumbnails_slider extends WP_Widget {

    /**
     * Register widget with WordPress.
     */
    function __construct() {
        parent::__construct('bitwallet_post_thumbnails_slider', esc_attr__('MT - Post thumbnails slider', 'bitwallet'),array( 'description' => esc_attr__( 'MT - Post thumbnails slider', 'bitwallet' ), ) );
    }
    ...
    public function form( $instance ) {
        ...
        if ( isset( $instance[ 'recent_posts_title' ] ) ) {
            ...
            $recent_posts_title = esc_attr__( 'Post thumbnails slider', 'bitwallet' );
        }
...
/* ========= bitwallet_social_share ===================================== */
class bitwallet_social_share extends WP_Widget {



    function __construct() {
        parent::__construct('bitwallet_social_share', esc_attr__('MT - Social Share Icons', 'bitwallet'),array( 'description' => esc_attr__( 'MT - Social Share Icons', 'bitwallet' ), ) );
    }
        ...
        <div class="sidebar-share-social-links">
            ...
            <ul class="share-social-links">
                ...
                <li class="pinterest">
                    ...
                    <?php /*<a href="http://pinterest.com/pin/create/button/?url=<?php echo esc_attr($siteurl); ?>&amp;media=<?php echo esc_attr(bitwallet_redux('mt_logo', 'url')); ?>&amp;description=<?php echo esc_attr($sitedescription); ?>" target="_blank"><i class="fa fa-pinterest"></i></a>*/ ?>
                </li>
    ...
    public function form( $instance ) {
        ...
        <p><?php esc_attr_e( 'Check what Social SHARE Buttons do you want to display','bitwallet' ); ?></p>
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_name('share-facebook')); ?>"><?php esc_attr_e( 'Facebook','bitwallet' ); ?></label>
        </p>
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_name('share-twitter')); ?>"><?php esc_attr_e( 'Twitter','bitwallet' ); ?></label>
        </p>
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_name('share-linkedin')); ?>"><?php esc_attr_e( 'Linkedin','bitwallet' ); ?></label>
        </p>
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_name('share-googleplus')); ?>"><?php esc_attr_e( 'Google Plus','bitwallet' ); ?></label>
        </p>
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_name('share-digg')); ?>"><?php esc_attr_e( 'Digg','bitwallet' ); ?></label>
        </p>
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_name('share-pinterest')); ?>"><?php esc_attr_e( 'Pinterest','bitwallet' ); ?></label>
        </p>
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_name('share-reddit')); ?>"><?php esc_attr_e( 'Reddit','bitwallet' ); ?></label>
        </p>
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_name('share-stumbleupon')); ?>"><?php esc_attr_e( 'Stumbleupon','bitwallet' ); ?></label>
        </p>
...
// Register Widgets
function bitwallet_register_widgets() {
    register_widget( 'bitwallet_address_social_icons' );
    register_widget( 'bitwallet_social_share' );
    register_widget( 'bitwallet_flickr' );
    register_widget( 'bitwallet_recent_entries_with_thumbnail' );
    register_widget( 'bitwallet_post_thumbnails_slider' );
    register_widget( 'bitwallet_popular_recent_tabs' );

}
add_action( 'widgets_init', 'bitwallet_register_widgets' );
?>
