(function ($) {
    ...
    function InitEventSource( url, $parent ){
        ...
        evtSource.addEventListener( 'log', function ( message ) {
            ...
            $('.demo-importer-message-info tbody').append( row );
        });
    }

    $(document)
        .on('click', '#live-log-status a', function(e){
            e.preventDefault();
            $('.demo-importer-message-info table').show();
        })
        .on('click','.wrap-importer .button',function(e){
            ...
            if(confirm($btn.data('title')) == true){
                ...
                $( '.demo-importer-message-info' ).empty();
                ...
                $.ajax({
                    ...
                    .done( function( response ) {
                        if ( 'undefined' !== typeof response.data) {
                            ...
                            $('.demo-importer-message-info').html('<div id="live-log-status" style="display:none;"><a href="#">View Log</a><table id="import-log" class="widefat" style="display:none;"><thead><tr><th>Type</th><th>Message</th></tr></thead><tbody></tbody></table></div>');
