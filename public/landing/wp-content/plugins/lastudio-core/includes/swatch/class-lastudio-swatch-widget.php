...
class LaStudio_Swatch_Widget extends WC_Widget{
    ...
    public function __construct() {
        ...
        $this->widget_description = __( 'Display a list of attributes to filter products in your store.', 'lastudio' );
        $this->widget_id          = 'woocommerce_layered_nav';
        $this->widget_name        = __( 'Filter Products by Attribute', 'lastudio' );
    ...
    public function init_settings() {
        ...
        $this->settings = array(
            'title' => array(
                'type'  => 'text',
                'std'   => __( 'Filter by', 'lastudio' ),
                'label' => __( 'Title', 'lastudio' )
            ),
            'attribute' => array(
                'type'    => 'select',
                'std'     => 'color',
                'label'   => __( 'Attribute', 'lastudio' ),
                'options' => $attribute_array
            ),
            'display_type' => array(
                'type'    => 'select',
                'std'     => 'list',
                'label'   => __( 'Display type', 'lastudio' ),
                'options' => array(
                    'swatches'     => __( 'Swatches', 'lastudio' ),
                    'list'     => __( 'List', 'lastudio' ),
                    'dropdown' => __( 'Dropdown', 'lastudio' )
                )
            ),
            'query_type' => array(
                'type'    => 'select',
                'std'     => 'and',
                'label'   => __( 'Query type', 'lastudio' ),
                'options' => array(
                    'and' => __( 'AND', 'lastudio' ),
                    'or'  => __( 'OR', 'lastudio' )
                )
    ...
    public function widget( $args, $instance ) {
        ...
        if($display_type !== 'dropdown' && $display_type !== 'swatches'){
            $__tmp .= ' widget_layered_nav--checkboxstyle';
    ...
    protected function layered_nav_dropdown( $terms, $taxonomy, $query_type ) {
        ...
        if ( $taxonomy !== $this->get_current_taxonomy() ) {
            ...
            echo '<option value="">' . sprintf( __( 'Any %s', 'lastudio' ), wc_attribute_label( $taxonomy ) ) . '</option>';
    ...
    protected function get_page_base_url( $taxonomy ) {
        ...
        $link = la_get_base_shop_url(false);
